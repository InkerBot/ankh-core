...
public class RelativeVector extends Vector {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof RelativeVector) {
      final RelativeVector vector = (RelativeVector) obj;
    ...
    return Math.abs(this.x - vector.getX()) < 1.0E-6
        && Math.abs(this.y - vector.getY()) < 1.0E-6
        && Math.abs(this.z - vector.getZ()) < 1.0E-6;
  }
