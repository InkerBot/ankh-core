...
public class Selector {
  ...
  protected boolean verify() {
    if (sender == null) {
      ...
      if (context != null && context.getSender() instanceof CommandSender) {
        this.sender = (CommandSender) context.getSender();
  ...
  public @Nonnull List<Entity> getEntities(CommandSender sender) {
