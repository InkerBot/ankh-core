...
public class BootstrapUtil {
  ...
  private static String createCbVersion() {
  ...
  private static ParsedMethod parseMethod(ClassLoader classLoader, String rawRef) throws ClassNotFoundException {
    String ref = processRef(rawRef);
  ...
  private static ParsedField parseField(ClassLoader classLoader, String rawRef) throws ClassNotFoundException {
    String ref = processRef(rawRef);
    int firstSplitIndex = ref.indexOf(';');
    int secondSplitIndex = ref.indexOf(':');
