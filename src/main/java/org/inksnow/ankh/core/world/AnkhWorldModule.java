...
public class AnkhWorldModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(WorldStorage.class).annotatedWith(Names.named("filesystem")).to(FilesystemWorldStorage.class);
    bind(WorldStorage.class).annotatedWith(Names.named("pdc")).to(PdcWorldStorage.class);
