...
public class MinecraftTypeAdapters {
  ...
  public static final ConfigTypeAdapter.Factory<Color> COLOR = createFactory(Color.class, it -> Color.fromRGB(Integer.parseInt(it.asString(), 16)));
  ...
  public static final ConfigTypeAdapter.Factory<ItemStack> ITEM_STACK = new ItemStackTypeAdapter.Factory();
