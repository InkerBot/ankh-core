...
import org.inksnow.ankh.core.api.plugin.ClasspathLoadType;
import org.inksnow.ankh.loader.libs.archive.Archive;
import org.inksnow.ankh.loader.libs.jar.Handler;
...
public class AnkhClassLoader extends URLClassLoader {
  ...
  private void clearCache(URLConnection connection) throws IOException {
    ...
    if (jarFile instanceof org.inksnow.ankh.loader.libs.jar.JarFile) {
      ((org.inksnow.ankh.loader.libs.jar.JarFile) jarFile).clearCache();
    }
  }
